...
public class BST{
    ...
    TreeNode rightRotate(TreeNode root){
        ...
        root.left  = y;
        //the first node is still pointing to the second left node : just making it null
        return x;
    ...
    TreeNode leftRotate(TreeNode root){
        ...
        root.right  = y;
        //the first node is still pointing to the second right node : just making it null
        return x;
